...
public class EnemyAwareness : MonoBehaviour
{
    ...
    [Tooltip("A measure of how certain the enemy is of the target's presence and position")] [Range(0.0f, 1.0f)]
    ...
    public Vector3 followPosition
    {
        get
        {
            ...
            if (returnPositionTransform != null) return returnPositionTransform.position;
    ...
    private void Start()
    {
        ...
        else if (target == null) target = FindObjectOfType<ThirdPersonCharacterController>().gameObject.transform;
    }
    ...
    {
        var visionCertainty = GetVisionCertainty();
        var hearingCertainty = GetHearingCertainty();
        var totalCertainty = visionCertainty + hearingCertainty;
    ...
    public float GetHearingCertainty()
    {
        ...
        {
            var speed = Mathf.Abs((target.position - lastHeardPosition).magnitude *
                                  Mathf.Pow(lastHeardTime - Time.timeSinceLevelLoad, -1.0f));
            var obstructionModifier = 1.0f;
