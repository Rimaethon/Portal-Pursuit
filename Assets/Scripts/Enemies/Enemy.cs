...
public class Enemy : MonoBehaviour
{
    ...
    [Header("Movement Settings")] [Tooltip("The base movement speed of the enemy.")]
    ...
    [Header("Behavior Settings")] [Tooltip("The shooter component that this enemy will use to attack, if it attacks")]
