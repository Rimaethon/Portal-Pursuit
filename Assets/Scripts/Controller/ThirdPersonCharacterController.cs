...
public class ThirdPersonCharacterController : PortalTraveller
{
    ...
    void LateUpdate()
    {
        ...
        CentralizedControl(inputManager.horizontalMoveAxis, inputManager.verticalMoveAxis, inputManager.jumpPressed, inputManager.ePressed);
    }
    ...
    void CentralizedControl(float leftRightMovementAxis, float forwardBackwardMovementAxis, bool jumpPressed, bool ePressed)
    {
    ...
    void NormalControl(float leftRightMovementAxis, float forwardBackwardMovementAxis, bool jumpPressed, bool ePressed)
    {
