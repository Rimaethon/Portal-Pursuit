...
///     Then the camera rotates the gameobject this script is attached to to make the camera rotate around the horizontal
///     and vertical smoothly
/// </summary>
public class CameraRotationHelper : MonoBehaviour
{
    [Header("Settings")] [Tooltip("The transform of the player")]
    ...
    {
        childCamera = gameObject.GetComponentInChildren<Camera>().gameObject;
        if (childCamera == null)
