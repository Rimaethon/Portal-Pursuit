...
{
    [Header("Bounce Settings")] [Tooltip("The force multiplyer to bounce the player by when jump is not held")]
    ...
    [Header("Effects")] [Tooltip("The effect to create when the player uses the jump pad")]
    public GameObject jumpPadEffect;

    [Header("Animation")] public Animator jumpPadAnimator;
    ...
    {
        if (collision.gameObject.tag == "Feet") BouncePlayer();
    }
    ...
    private void BouncePlayer()
    {
        ...
        if (playerController != null)
        {
            ...
            if (jumpPadEffect != null) Instantiate(jumpPadEffect, transform.position, transform.rotation, null);
