...
{
    [Header("Score Pickup Settings")] [Tooltip("The amount of score gained when picked up.")]
    ...
    {
        if (collision.tag == "Player" && GameManager.instance != null) GameManager.AddScore(scoreAmount);
